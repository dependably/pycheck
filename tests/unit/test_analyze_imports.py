...
class TestAnalyzeImports:
    ...
    def test_analyze_mixed_import_types(self):
        ...
        imports = [
            ...
            ImportInfo("pathlib", ["Path"], alias="P", line_number=4, is_from_import=True)  # From import with alias, used
        ]
    ...
    def test_analyze_case_sensitivity(self):
        ...
        imports = [
            ImportInfo("OS", [], line_number=1),  # Different case
            ImportInfo("sys", [], line_number=2)
        ]
    ...
    def test_analyze_star_import(self):
        ...
        imports = [
            ImportInfo("math", ["*"], line_number=1, is_from_import=True)
        ]
    ...
    def test_analyze_preserves_import_info(self):
        ...
        imports = [
            ImportInfo("os", [], alias="operating_system", line_number=5)
        ]
